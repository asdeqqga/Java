...
public class WrapperTest {
	public static void main(String[] args) {
		...
		int     values1 = Integer.parseInt(str1);
		double  values2 = Double.parseDouble(str2);
		boolean values3 = Boolean.parseBoolean(str3);

...
public class StringTest {
	public static void main(String[] args) {
		...
		String str2 = new String("Hello"); // 리터럴(명시적)
		...
		// 문자열 비교
		if(str1 == str2) {
			System.out.println("str1과 주소와 str2가 주소가 같다.");
		}else {
			System.out.println("str1과 주소와 str2가 주소가 다르다");
		}
		...
		System.out.println("smalpe 길이 : "+sample.length());
